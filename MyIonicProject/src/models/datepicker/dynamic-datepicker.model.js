...
var DynamicDatePickerModel = /** @class */ (function (_super) {
    ...
    function DynamicDatePickerModel(config, cls) {
        ...
        _this.inline = typeof config.inline === "boolean" ? config.inline : false;
        _this.toggleIcon = typeof config.toggleIcon === "string" ? config.toggleIcon : null;
        return _this;
    }
    __decorate([
        serializable(),
